...
Es imprescindible que cada alumno/a traiga su propio **portátil con conexión WiFi**. 

Si se pertenece a una institución académica (universidades, CSIC), es muy recomendable traer **eduroam configurado** de antemano para el acceso WiFi. Para ello pueden utilizarse aplicaciones que ayudan con la instalación (<https://www.geteduroam.app/>, <https://cat.eduroam.org/>). En caso de duda consultar con el servicio de informática de la institución correspondiente. Para los alumnos sin acceso a eduroam se dispondrá de una red wifi alternativa.

Previamente al comienzo del curso **deberá instalarse**:
...
-   Los paquetes incluidos [aquí](https://raw.githubusercontent.com/Rstats-courses/cursoR-AEET-2026/master/pkgs2install.R), actualizados a su última versión. Probablemente la forma más fácil es ejecutar `source("https://raw.githubusercontent.com/Rstats-courses/cursoR-AEET-2026/master/pkgs2install.R")` desde vuestro R para instalar la última versión de todos los paquetes.
...
<!-- This below moved to post in Discussion to avoid confussion

https://github.com/Rstats-courses/CursoR-AEET-2025/discussions/2

### Resolución de problemas con Git, Rstudio y GitHub
